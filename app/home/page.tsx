...
const Page = () => {
  ...
  <header>
    <nav className="navbar">
      ...
      <span className='text-green-500 text-3xl'>Miro.</span>
      </a>
      <ul className="menu-links">
        <li>
          <a href="https://diverse-egret-46.accounts.dev/sign-in">Miro. Business</a>
        </li>
        <li>
          <a href="https://diverse-egret-46.accounts.dev/sign-in">Explore</a>
        </li>
       
        <li>
          <a href="https://diverse-egret-46.accounts.dev/sign-in">Sell Gigs</a>
        </li>
        <li>
          <a href="https://diverse-egret-46.accounts.dev/sign-in">Sign In</a>
        </li>
        <li className="join-btn">
          <a href="https://diverse-egret-46.accounts.dev/sign-up">Join Us</a>
        </li>
  ...
  <section className="hero-section">
    <div className="content">
      ...
      <div className="popular-tags">
        ...
        <ul className="tags">
          <li>
            <a href="https://diverse-egret-46.accounts.dev/sign-in">Webite Design</a>
          </li>
          <li>
            <a href="https://diverse-egret-46.accounts.dev/sign-in">Logo Design</a>
          </li>
          <li>
            <a href="https://diverse-egret-46.accounts.dev/sign-in">WordPress</a>
          </li>
          <li>
            <a href="https://diverse-egret-46.accounts.dev/sign-in">AI Design</a>
          </li>
        </ul>
      </div>
    </div>
...
<footer className="relative z-10  dark:bg-dark text-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        ...
        <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div className="w-full mb-10">
            ...
            <p className="flex items-center text-sm font-medium text-dark dark:text-white">
              ...
              <span> <a href="tel:+233543826534">+233543826534</a> </span>
            </p>
          </div>
        </div>
